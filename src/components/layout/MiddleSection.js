    ...
    <div>
      ...
      <div className="my-skills" id="about">
        ...
        <p className="about-description">
          ...
          I am a passionate and creative full-stack developer with a strong love
          for learning and problem-solving. Programming allows me to
          continuously expand my knowledge while satisfying my creative needs
          through developing new software and customizing their look and feel.
          <br />
          <br />
          Throughout my software development journey, I have gained proficiency
          in a wide range of technologies and version control systems. Some of
          my key skills include:
          <br />
          <br />
          JavaScript - C# - .NET - React - Vue - PHP - HTML - CSS - WordPress -
          Bootstrap - Tailwind - Sass - API - Node.js - Express.js - MongoDB -
          Git - Postman - Railway - Azure - and MORE!
          <br />
          <br />
          What excites me the most about technology is its immense potential to
          impact people's lives in meaningful ways. I am driven by the
          opportunity to utilize my knowledge and skills to craft intuitive and
          user-friendly products that address real-world needs. It is my goal to
          create solutions that not only meet user requirements but also enhance
