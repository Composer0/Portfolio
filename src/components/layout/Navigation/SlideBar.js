        ...
        <SideBarContainer isOpen={isOpen} onClick={toggle}>
            ...
            <SideBarWrapper>
                <SideBarMenu>
                    ...
                    <br/>
                    <br/>
                    <a href={"https://drive.google.com/file/d/1KENaChAitbCTfbzwhLZtelaHEIWmcd6N/view?usp=share_link"} className="resume-setting" rel="noopener noreferrer" target="_blank" onClick={toggle}>
                    <SideBarLinkResume>
                    Resume
                    </SideBarLinkResume>
                    </a>
